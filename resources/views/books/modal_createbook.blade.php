<x-modal name="create-book-modal" focusable>
    <div class="p-6">
        ...
        <form method="POST" action="{{ route('books.store') }}">
            ...
            <div x-data="{
                authorQuery: '',
                showAuthors: false,
                authors: {{ $authors->map(fn($a) => $a->name) }}, // Ambil data author dari backend
                selectedCategories: [],
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                    ...
                    <div>
                        <x-input-label for="published_year" value="Tahun Terbit" />
                        <x-text-input id="published_year" name="published_year" type="number" class="mt-1 block w-full" required />
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                    ...
                    <x-primary-button class="bg-blue-600 hover:bg-blue-700">Simpan Buku</x-primary-button>
                </div>
